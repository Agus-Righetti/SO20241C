...
{    
    ...
    int direccion_inicio = 0;
    int cantidad_instrucciones = 100; // No se que valor va aca

    int cod_op_cpu = solicitar_instrucciones_a_memoria(conexion_cpu_memoria, direccion_inicio, cantidad_instrucciones);
